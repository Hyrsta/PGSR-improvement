...
# scenes = [37, 40, 55, 63, 65, 69, 83, 97, 105, 106, 110, 114, 118, 122]
...
#     cmd = f'CUDA_VISIBLE_DEVICES={gpu_id} python train_roma.py -s {data_base_path}/scan{scene} -m {out_base_path}/dtu_scan{scene}/{out_name} {common_args}'
#     print(cmd)
#     os.system(cmd)
